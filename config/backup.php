...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                'include' => [
                    storage_path('app/public'), // fișiere uploadate de utilizatori
                    base_path('.env'),           // configurația aplicației (nu ajunge pe cloud public)
                ],
        ...
        'destination' => [
             ...
             */
            'disks' => [
                'local', // stocare locală pentru testare și acces rapid
                'b2',    // Backblaze B2 — backup off-site (completează .env după creare cont)
            ],
    ...
    'notifications' => [
        'notifications' => [
            // Critice — trimise întotdeauna
            BackupHasFailedNotification::class       => ['mail'],
            UnhealthyBackupWasFoundNotification::class => ['mail'],
            CleanupHasFailedNotification::class      => ['mail'],
            // Informaționale — confirmare că totul e OK
            BackupWasSuccessfulNotification::class   => ['mail'],
            // Dezactivate — prea mult zgomot zilnic
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFICATION_EMAIL', 'admin@firma-mea.ro'),

            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'backup@crm-firma.ro'),
                'name' => env('MAIL_FROM_NAME', 'CRM Firma Backup'),
            ],
        ],
