...
class SystemAlertResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Alertă sistem';

    protected static ?string $pluralModelLabel = 'Alerte sistem';

    protected static ?string $navigationLabel = 'Alerte sistem';

    protected static ?string $slug = 'system-alerts';
